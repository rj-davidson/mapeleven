...
func (tftsu *TSFailedToScoreUpdate) Save(ctx context.Context) (int, error) {
	tftsu.defaults()
	return withHooks[int, TSFailedToScoreMutation](ctx, tftsu.sqlSave, tftsu.mutation, tftsu.hooks)
}
...
func (tftsuo *TSFailedToScoreUpdateOne) Save(ctx context.Context) (*TSFailedToScore, error) {
	tftsuo.defaults()
	return withHooks[*TSFailedToScore, TSFailedToScoreMutation](ctx, tftsuo.sqlSave, tftsuo.mutation, tftsuo.hooks)
}
