...
func (tlu *TSLineupsUpdate) Save(ctx context.Context) (int, error) {
	tlu.defaults()
	return withHooks[int, TSLineupsMutation](ctx, tlu.sqlSave, tlu.mutation, tlu.hooks)
}
...
func (tluo *TSLineupsUpdateOne) Save(ctx context.Context) (*TSLineups, error) {
	tluo.defaults()
	return withHooks[*TSLineups, TSLineupsMutation](ctx, tluo.sqlSave, tluo.mutation, tluo.hooks)
}
