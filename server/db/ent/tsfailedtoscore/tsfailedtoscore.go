...
const (
	// Label holds the string label denoting the tsfailedtoscore type in the database.
	Label = "ts_failed_to_score"
	...
	EdgeTeam = "team"
	// Table holds the table name of the tsfailedtoscore in the database.
	Table = "ts_failed_to_scores"
	// TeamTable is the table that holds the team relation/edge.
	TeamTable = "ts_failed_to_scores"
	// TeamInverseTable is the table name for the Team entity.
	// It exists in this package in order to avoid circular dependency with the "team" package.
	TeamInverseTable = "teams"
	// TeamColumn is the table column denoting the team relation/edge.
	TeamColumn = "team_failed_to_score_stats"
)

// Columns holds all SQL columns for tsfailedtoscore fields.
var Columns = []string{
	FieldID,
	FieldHome,
	FieldAway,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "ts_failed_to_scores"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"team_failed_to_score_stats",
}
...
// Order defines the ordering method for the TSFailedToScore queries.
