...
// Order defines the ordering method for the MatchPlayer queries.
...
func ByLineupField(field string, opts ...sql.OrderTermOption) Order {
	return func(s *sql.Selector) {
