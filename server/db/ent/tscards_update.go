...
func (tcu *TSCardsUpdate) Save(ctx context.Context) (int, error) {
	tcu.defaults()
	return withHooks[int, TSCardsMutation](ctx, tcu.sqlSave, tcu.mutation, tcu.hooks)
}
...
func (tcuo *TSCardsUpdateOne) Save(ctx context.Context) (*TSCards, error) {
	tcuo.defaults()
	return withHooks[*TSCards, TSCardsMutation](ctx, tcuo.sqlSave, tcuo.mutation, tcuo.hooks)
}
