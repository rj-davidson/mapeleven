...
func (tbu *TSBiggestUpdate) Save(ctx context.Context) (int, error) {
	tbu.defaults()
	return withHooks[int, TSBiggestMutation](ctx, tbu.sqlSave, tbu.mutation, tbu.hooks)
}
...
func (tbuo *TSBiggestUpdateOne) Save(ctx context.Context) (*TSBiggest, error) {
	tbuo.defaults()
	return withHooks[*TSBiggest, TSBiggestMutation](ctx, tbuo.sqlSave, tbuo.mutation, tbuo.hooks)
}
