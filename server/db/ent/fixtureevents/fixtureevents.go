...
const (
	...
	TeamColumn = "team_fixture_events"
)
...
// Order defines the ordering method for the FixtureEvents queries.
...
func ByDetail(opts ...sql.OrderTermOption) Order {
...
func ByAssistField(field string, opts ...sql.OrderTermOption) Order {
	return func(s *sql.Selector) {
