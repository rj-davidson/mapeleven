...
func (tcsu *TSCleanSheetUpdate) Save(ctx context.Context) (int, error) {
	tcsu.defaults()
	return withHooks[int, TSCleanSheetMutation](ctx, tcsu.sqlSave, tcsu.mutation, tcsu.hooks)
}
...
func (tcsuo *TSCleanSheetUpdateOne) Save(ctx context.Context) (*TSCleanSheet, error) {
	tcsuo.defaults()
	return withHooks[*TSCleanSheet, TSCleanSheetMutation](ctx, tcsuo.sqlSave, tcsuo.mutation, tcsuo.hooks)
}
