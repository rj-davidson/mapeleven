...
// OrderOption defines the ordering options for the Fixture queries.
...
func ByReferee(opts ...sql.OrderTermOption) OrderOption {
...
func ByFixtureEventsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
...
func ByFixtureEvents(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
