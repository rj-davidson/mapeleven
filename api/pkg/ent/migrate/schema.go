...
var (
	...
	PsFairplaysTable = &schema.Table{
		Name:       "ps_fairplays",
		Columns:    PsFairplaysColumns,
		PrimaryKey: []*schema.Column{PsFairplaysColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "ps_fairplays_player_stats_psFairplay",
				Columns:    []*schema.Column{PsFairplaysColumns[7]},
				RefColumns: []*schema.Column{PlayerStatsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	PsGamesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "ps_games_player_stats_psGames",
				Columns:    []*schema.Column{PsGamesColumns[9]},
				RefColumns: []*schema.Column{PlayerStatsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	PsShootingsTable = &schema.Table{
		Name:       "ps_shootings",
		Columns:    PsShootingsColumns,
		PrimaryKey: []*schema.Column{PsShootingsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "ps_shootings_player_stats_psShooting",
				Columns:    []*schema.Column{PsShootingsColumns[8]},
				RefColumns: []*schema.Column{PlayerStatsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	PsSubstitutesTable = &schema.Table{
		Name:       "ps_substitutes",
		Columns:    PsSubstitutesColumns,
		PrimaryKey: []*schema.Column{PsSubstitutesColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "ps_substitutes_player_stats_psSubstitutes",
				Columns:    []*schema.Column{PsSubstitutesColumns[5]},
				RefColumns: []*schema.Column{PlayerStatsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	PsTechnicalsTable = &schema.Table{
		Name:       "ps_technicals",
		Columns:    PsTechnicalsColumns,
		PrimaryKey: []*schema.Column{PsTechnicalsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
	...
	PlayersColumns = []*schema.Column{
		...
		{Name: "photo", Type: field.TypeString},
		{Name: "last_updated", Type: field.TypeTime, Nullable: true},
		{Name: "game_appearances", Type: field.TypeInt},
		{Name: "game_lineups", Type: field.TypeInt},
		{Name: "game_minutes", Type: field.TypeInt},
		{Name: "total_shots", Type: field.TypeInt},
		{Name: "shots_on_target", Type: field.TypeInt},
		{Name: "total_goals", Type: field.TypeInt},
		{Name: "assists", Type: field.TypeInt},
		{Name: "goals_conceded", Type: field.TypeInt},
		{Name: "saves", Type: field.TypeInt},
		...
		{Name: "league_name", Type: field.TypeString},
		{Name: "pass_total", Type: field.TypeInt},
		{Name: "pass_key", Type: field.TypeInt},
		{Name: "pass_accuracy", Type: field.TypeInt},
		{Name: "total_tackle", Type: field.TypeInt},
		{Name: "blocks", Type: field.TypeInt, Default: 0},
		{Name: "interceptions", Type: field.TypeInt, Default: 0},
		{Name: "duels_total", Type: field.TypeInt},
		{Name: "duels_won", Type: field.TypeInt},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{PlayersColumns[35]},
				RefColumns: []*schema.Column{BirthsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "players_countries_players",
				Columns:    []*schema.Column{PlayersColumns[36]},
				RefColumns: []*schema.Column{CountriesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	PlayerStatsColumns = []*schema.Column{
		...
		{Name: "team_player_stats", Type: field.TypeInt, Nullable: true},
	}
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{PlayerStatsColumns[2]},
				RefColumns: []*schema.Column{PlayersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "player_stats_teams_playerStats",
	...
	// PlayerStatsSeasonColumns holds the columns for the "player_stats_season" table.
	PlayerStatsSeasonColumns = []*schema.Column{
		{Name: "player_stats_id", Type: field.TypeInt},
		{Name: "season_id", Type: field.TypeInt},
	}
	// PlayerStatsSeasonTable holds the schema information for the "player_stats_season" table.
	PlayerStatsSeasonTable = &schema.Table{
		Name:       "player_stats_season",
		Columns:    PlayerStatsSeasonColumns,
		PrimaryKey: []*schema.Column{PlayerStatsSeasonColumns[0], PlayerStatsSeasonColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "player_stats_season_player_stats_id",
				Columns:    []*schema.Column{PlayerStatsSeasonColumns[0]},
				RefColumns: []*schema.Column{PlayerStatsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "player_stats_season_season_id",
				Columns:    []*schema.Column{PlayerStatsSeasonColumns[1]},
				RefColumns: []*schema.Column{SeasonsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
...
func init() {
	...
	PsDefensesTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsFairplaysTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsGamesTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsPenaltiesTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsShootingsTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsSubstitutesTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PsTechnicalsTable.ForeignKeys[0].RefTable = PlayerStatsTable
	...
	PlayerStatsTable.ForeignKeys[1].RefTable = TeamsTable
	...
	PlayerStatsSeasonTable.ForeignKeys[0].RefTable = PlayerStatsTable
	PlayerStatsSeasonTable.ForeignKeys[1].RefTable = SeasonsTable
}
