...
type TeamQuery struct {
	...
	withFailedToScoreStats *TSFailedToScoreQuery
	withFixturesStats      *TSFixturesQuery
...
func (tq *TeamQuery) QuerySeason() *SeasonQuery {
	query := (&SeasonClient{config: tq.config}).Query()
...
func (tq *TeamQuery) QueryClub() *ClubQuery {
	query := (&ClubClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TeamQuery) QueryPlayerStats() *PlayerStatsQuery {
	query := (&PlayerStatsClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryBiggestStats chains the current query on the "biggest_stats" edge.
func (tq *TeamQuery) QueryBiggestStats() *TSBiggestQuery {
	query := (&TSBiggestClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryCardsStats chains the current query on the "cards_stats" edge.
func (tq *TeamQuery) QueryCardsStats() *TSCardsQuery {
	query := (&TSCardsClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryCleanSheetStats chains the current query on the "clean_sheet_stats" edge.
func (tq *TeamQuery) QueryCleanSheetStats() *TSCleanSheetQuery {
	query := (&TSCleanSheetClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryFailedToScoreStats chains the current query on the "failed_to_score_stats" edge.
func (tq *TeamQuery) QueryFailedToScoreStats() *TSFailedToScoreQuery {
	query := (&TSFailedToScoreClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryFixturesStats chains the current query on the "fixtures_stats" edge.
func (tq *TeamQuery) QueryFixturesStats() *TSFixturesQuery {
	query := (&TSFixturesClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryGoalsStats chains the current query on the "goals_stats" edge.
func (tq *TeamQuery) QueryGoalsStats() *TSGoalsQuery {
	query := (&TSGoalsClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryLineups chains the current query on the "lineups" edge.
func (tq *TeamQuery) QueryLineups() *TSLineupsQuery {
	query := (&TSLineupsClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryPenaltyStats chains the current query on the "penalty_stats" edge.
func (tq *TeamQuery) QueryPenaltyStats() *TSPenaltyQuery {
	query := (&TSPenaltyClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TeamQuery) Clone() *TeamQuery {
	...
	return &TeamQuery{
		...
		withSeason:             tq.withSeason.Clone(),
		withClub:               tq.withClub.Clone(),
		withPlayerStats:        tq.withPlayerStats.Clone(),
		...
		withFailedToScoreStats: tq.withFailedToScoreStats.Clone(),
		withFixturesStats:      tq.withFixturesStats.Clone(),
...
func (tq *TeamQuery) WithSeason(opts ...func(*SeasonQuery)) *TeamQuery {
	query := (&SeasonClient{config: tq.config}).Query()
...
func (tq *TeamQuery) WithClub(opts ...func(*ClubQuery)) *TeamQuery {
	query := (&ClubClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TeamQuery) WithPlayerStats(opts ...func(*PlayerStatsQuery)) *TeamQuery {
	query := (&PlayerStatsClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withPlayerStats = query
	return tq
}
...
// WithBiggestStats tells the query-builder to eager-load the nodes that are connected to
// the "biggest_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithBiggestStats(opts ...func(*TSBiggestQuery)) *TeamQuery {
	query := (&TSBiggestClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withBiggestStats = query
	return tq
}

// WithCardsStats tells the query-builder to eager-load the nodes that are connected to
// the "cards_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithCardsStats(opts ...func(*TSCardsQuery)) *TeamQuery {
	query := (&TSCardsClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withCardsStats = query
	return tq
}

// WithCleanSheetStats tells the query-builder to eager-load the nodes that are connected to
// the "clean_sheet_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithCleanSheetStats(opts ...func(*TSCleanSheetQuery)) *TeamQuery {
	query := (&TSCleanSheetClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withCleanSheetStats = query
	return tq
}

// WithFailedToScoreStats tells the query-builder to eager-load the nodes that are connected to
// the "failed_to_score_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithFailedToScoreStats(opts ...func(*TSFailedToScoreQuery)) *TeamQuery {
	query := (&TSFailedToScoreClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withFailedToScoreStats = query
	return tq
}

// WithFixturesStats tells the query-builder to eager-load the nodes that are connected to
// the "fixtures_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithFixturesStats(opts ...func(*TSFixturesQuery)) *TeamQuery {
	query := (&TSFixturesClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withFixturesStats = query
	return tq
}

// WithGoalsStats tells the query-builder to eager-load the nodes that are connected to
// the "goals_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithGoalsStats(opts ...func(*TSGoalsQuery)) *TeamQuery {
	query := (&TSGoalsClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withGoalsStats = query
	return tq
}

// WithLineups tells the query-builder to eager-load the nodes that are connected to
// the "lineups" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithLineups(opts ...func(*TSLineupsQuery)) *TeamQuery {
	query := (&TSLineupsClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withLineups = query
	return tq
}

// WithPenaltyStats tells the query-builder to eager-load the nodes that are connected to
// the "penalty_stats" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TeamQuery) WithPenaltyStats(opts ...func(*TSPenaltyQuery)) *TeamQuery {
	query := (&TSPenaltyClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withPenaltyStats = query
	return tq
}
...
func (tq *TeamQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Team, error) {
	var (
		...
		loadedTypes = [17]bool{
			...
			tq.withFailedToScoreStats != nil,
			tq.withFixturesStats != nil,
	...
	if query := tq.withSeason; query != nil {
		if err := tq.loadSeason(ctx, query, nodes, nil,
			func(n *Team, e *Season) { n.Edges.Season = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withClub; query != nil {
		if err := tq.loadClub(ctx, query, nodes, nil,
			func(n *Team, e *Club) { n.Edges.Club = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withPlayerStats; query != nil {
		if err := tq.loadPlayerStats(ctx, query, nodes,
			func(n *Team) { n.Edges.PlayerStats = []*PlayerStats{} },
			func(n *Team, e *PlayerStats) { n.Edges.PlayerStats = append(n.Edges.PlayerStats, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := tq.withCardsStats; query != nil {
		if err := tq.loadCardsStats(ctx, query, nodes, nil,
			func(n *Team, e *TSCards) { n.Edges.CardsStats = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withCleanSheetStats; query != nil {
		if err := tq.loadCleanSheetStats(ctx, query, nodes, nil,
			func(n *Team, e *TSCleanSheet) { n.Edges.CleanSheetStats = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withFailedToScoreStats; query != nil {
		if err := tq.loadFailedToScoreStats(ctx, query, nodes, nil,
			func(n *Team, e *TSFailedToScore) { n.Edges.FailedToScoreStats = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withFixturesStats; query != nil {
		if err := tq.loadFixturesStats(ctx, query, nodes, nil,
			func(n *Team, e *TSFixtures) { n.Edges.FixturesStats = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withGoalsStats; query != nil {
		if err := tq.loadGoalsStats(ctx, query, nodes, nil,
			func(n *Team, e *TSGoals) { n.Edges.GoalsStats = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withLineups; query != nil {
		if err := tq.loadLineups(ctx, query, nodes,
			func(n *Team) { n.Edges.Lineups = []*TSLineups{} },
			func(n *Team, e *TSLineups) { n.Edges.Lineups = append(n.Edges.Lineups, e) }); err != nil {
			return nil, err
		}
	}
...
func (tq *TeamQuery) loadSeason(ctx context.Context, query *SeasonQuery, nodes []*Team, init func(*Team), assign func(*Team, *Season)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Team)
	for i := range nodes {
		if nodes[i].season_teams == nil {
			continue
		}
		fk := *nodes[i].season_teams
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "season_teams" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (tq *TeamQuery) loadClub(ctx context.Context, query *ClubQuery, nodes []*Team, init func(*Team), assign func(*Team, *Club)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Team)
	for i := range nodes {
		if nodes[i].club_team == nil {
			continue
		}
		fk := *nodes[i].club_team
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "club_team" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (tq *TeamQuery) loadPlayerStats(ctx context.Context, query *PlayerStatsQuery, nodes []*Team, init func(*Team), assign func(*Team, *PlayerStats)) error {
	...
	query.Where(predicate.PlayerStats(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.PlayerStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_player_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_player_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_player_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadStandings(ctx context.Context, query *StandingsQuery, nodes []*Team, init func(*Team), assign func(*Team, *Standings)) error {
	...
	query.Where(predicate.Standings(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.StandingsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_standings" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadHomeFixtures(ctx context.Context, query *FixtureQuery, nodes []*Team, init func(*Team), assign func(*Team, *Fixture)) error {
	...
	query.Where(predicate.Fixture(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.HomeFixturesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_home_fixtures" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadAwayFixtures(ctx context.Context, query *FixtureQuery, nodes []*Team, init func(*Team), assign func(*Team, *Fixture)) error {
	...
	query.withFKs = true
	query.Where(predicate.Fixture(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.AwayFixturesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_away_fixtures" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadTeamFixtureEvents(ctx context.Context, query *FixtureEventsQuery, nodes []*Team, init func(*Team), assign func(*Team, *FixtureEvents)) error {
	...
	query.Where(predicate.FixtureEvents(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.TeamFixtureEventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_team_fixture_events" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadFixtureLineups(ctx context.Context, query *FixtureLineupsQuery, nodes []*Team, init func(*Team), assign func(*Team, *FixtureLineups)) error {
	...
	query.Where(predicate.FixtureLineups(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.FixtureLineupsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_fixture_lineups" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TeamQuery) loadSquad(ctx context.Context, query *SquadQuery, nodes []*Team, init func(*Team), assign func(*Team, *Squad)) error {
	...
	query.Where(predicate.Squad(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.SquadColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_squad" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadBiggestStats(ctx context.Context, query *TSBiggestQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSBiggest)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSBiggest(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.BiggestStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_biggest_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_biggest_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_biggest_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadCardsStats(ctx context.Context, query *TSCardsQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSCards)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSCards(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.CardsStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_cards_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_cards_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_cards_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadCleanSheetStats(ctx context.Context, query *TSCleanSheetQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSCleanSheet)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSCleanSheet(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.CleanSheetStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_clean_sheet_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_clean_sheet_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_clean_sheet_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadFailedToScoreStats(ctx context.Context, query *TSFailedToScoreQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSFailedToScore)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSFailedToScore(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.FailedToScoreStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_failed_to_score_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_failed_to_score_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_failed_to_score_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadFixturesStats(ctx context.Context, query *TSFixturesQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSFixtures)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSFixtures(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.FixturesStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_fixtures_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_fixtures_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_fixtures_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadGoalsStats(ctx context.Context, query *TSGoalsQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSGoals)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSGoals(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.GoalsStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_goals_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_goals_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_goals_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (tq *TeamQuery) loadLineups(ctx context.Context, query *TSLineupsQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSLineups)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tslineups.FieldTeamID)
	}
	query.Where(predicate.TSLineups(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.LineupsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TeamQuery) loadPenaltyStats(ctx context.Context, query *TSPenaltyQuery, nodes []*Team, init func(*Team), assign func(*Team, *TSPenalty)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.TSPenalty(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.PenaltyStatsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.team_penalty_stats
		if fk == nil {
			return fmt.Errorf(`foreign-key "team_penalty_stats" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "team_penalty_stats" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
