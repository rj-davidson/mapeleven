...
// OrderOption defines the ordering options for the FixtureLineups queries.
...
func ByLineupPlayerCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
...
func ByLineupPlayer(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
