...
const FixtureLineup: React.FC<FixtureLineupProps> = ({ homePlayers, awayPlayers }) => {
    const [homePhotos, setHomePhotos] = React.useState<{ [slug: string]: string }>({});
    const [awayPhotos, setAwayPhotos] = React.useState<{ [slug: string]: string }>({});
