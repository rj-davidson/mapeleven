...
> = ({ playerData }) => {
  ...
  const shots: PlayerStatsShootingPieChartData[] = [
    {
      name: "Saves",
      shots: playerData?.statistics?.[0].shooting.saves || 0,
    },
    {
      name: "Blocks",
      shots: playerData?.statistics?.[0].defense.blocks || 0,
    },
    {
      name: "Duels Won",
      shots: playerData?.statistics?.[0].defense.duels_won || 0,
    },
    {
      name: "Interceptions",
      shots: playerData?.statistics?.[0].defense.interceptions || 0,
    },
    {
      name: "Duels Lost",
      shots:
        (playerData?.statistics?.[0].defense.duels_total || 0) -
        (playerData?.statistics?.[0].defense.duels_won || 0),
    },
  ];
