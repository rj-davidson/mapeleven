  ...
  const shots: PlayerStatsShootingPieChartData[] = [
    {
      name: "Failed Passes",
      shots: Math.round(
        (playerData?.statistics?.[0].technical.passes || 0) *
          ((100 - (playerData?.statistics?.[0].technical.pass_accuracy || 0)) /
            100)
      ),
    },
    {
      ...
      shots: Math.round(
        (playerData?.statistics?.[0].technical.passes || 0) *
          ((playerData?.statistics?.[0].technical.pass_accuracy || 0) / 100) -
          (playerData?.statistics?.[0].technical.key_passes || 0)
      ),
    },
    {
      name: "Key Passes",
      shots: playerData?.statistics?.[0].technical.key_passes || 0,
    },
  ];
